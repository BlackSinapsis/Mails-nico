> Actualización de alcance: el análisis de los cortes quincenales, sus reglas y la evaluación de Twenty están centralizados en [Documentos/00_INDICE.md](../Documentos/00_INDICE.md). Los documentos 01–09 incorporan la última definición del usuario y prevalecen ante diferencias con este antecedente.
